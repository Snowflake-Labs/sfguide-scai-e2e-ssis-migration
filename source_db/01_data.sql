...
VALUES
    (1,   1,  1,  '2024-07-10 12:15:00', '2024-07-10 12:15:00 -04:00', 'Completed', 29.98,  5.00, 'Credit Card', NULL),
    (2,   1,  4,  '2024-07-12 13:30:00', '2024-07-12 13:30:00 -04:00', 'Completed', 25.98,  4.00, 'Credit Card', N'Extra pickles on burger'),
    (3,   2,  2,  '2024-07-15 11:45:00', '2024-07-15 11:45:00 -07:00', 'Completed', 12.99,  2.00, 'Cash',        NULL),
    (4,   3,  6,  '2024-07-18 12:00:00', '2024-07-18 12:00:00 -04:00', 'Completed', 29.98,  5.00, 'Debit Card',  NULL),
    (5,   4,  8,  '2024-07-20 18:30:00', '2024-07-20 18:30:00 -05:00', 'Completed', 26.98,  3.00, 'Credit Card', NULL),
    (6,   5,  3,  '2024-07-22 19:00:00', '2024-07-22 19:00:00 +09:00', 'Completed', 42.97,  6.00, 'Mobile Pay',  N'No pork in udon please'),
    (7,   6,  5,  '2024-07-25 20:15:00', '2024-07-25 20:15:00 +01:00', 'Completed', 28.98,  4.50, 'Credit Card', NULL),
    (8,   7,  7,  '2024-08-01 14:00:00', '2024-08-01 14:00:00 +02:00', 'Completed', 21.98,  3.00, 'Cash',        NULL),
    (9,   8, 11,  '2024-08-05 10:30:00', '2024-08-05 10:30:00 -03:00', 'Completed', 24.98,  4.00, 'Credit Card', NULL),
    (10,  9,  9,  '2024-08-10 12:45:00', '2024-08-10 12:45:00 -07:00', 'Completed', 24.98,  3.50, 'Debit Card',  NULL),
    (11, 10,  1,  '2024-08-15 11:00:00', '2024-08-15 11:00:00 -07:00', 'Completed', 16.99,  2.50, 'Mobile Pay',  NULL),
    (12, 11,  4,  '2024-08-18 12:30:00', '2024-08-18 12:30:00 -04:00', 'Completed', 37.97,  6.00, 'Credit Card', N'Double everything'),
    (13, 12, 10,  '2024-08-20 15:00:00', '2024-08-20 15:00:00 -05:00', 'Completed',  7.99,  1.00, 'Cash',        NULL),
    (14, 14,  3,  '2024-08-22 19:30:00', '2024-08-22 19:30:00 +09:00', 'Completed', 29.98,  5.00, 'Mobile Pay',  NULL),
    (15,  5,  3,  '2024-08-25 18:00:00', NULL,                          'Pending',   14.99,  0.00, NULL,          NULL),
    (16,  1,  1,  '2024-09-01 12:00:00', '2024-09-01 12:00:00 -04:00', 'Completed', 10.99,  2.00, 'Credit Card', NULL),
    (17,  3,  6,  '2024-09-05 13:15:00', '2024-09-05 13:15:00 -04:00', 'Completed', 42.97,  7.00, 'Debit Card',  N'Extra spicy'),
    (18,  2,  2,  '2024-09-10 12:30:00', NULL,                          'Pending',    8.99,  0.00, NULL,          NULL),
    (19, 11,  1,  '2024-09-12 11:45:00', '2024-09-12 11:45:00 -04:00', 'Completed', 27.98,  4.00, 'Credit Card', NULL),
    (20, 13,  2,  '2024-09-15 14:00:00', '2024-09-15 14:00:00 -07:00', 'Completed',  4.50,  1.00, 'Cash',        NULL),
    (21,  4,  8,  '2024-09-18 17:30:00', NULL,                          'Cancelled',  0.00,  0.00, NULL,          N'Customer cancelled'),
    (22,  6,  5,  '2024-09-20 19:45:00', '2024-09-20 19:45:00 +01:00', 'Completed', 13.99,  2.00, 'Credit Card', NULL),
    (23, 14,  3,  '2024-09-25 20:00:00', '2024-09-25 20:00:00 +09:00', 'Completed', 14.99,  3.00, 'Mobile Pay',  NULL),
    (24,  7,  7,  '2024-10-01 13:30:00', '2024-10-01 13:30:00 +02:00', 'Completed',  9.99,  1.50, 'Cash',        NULL),
    (25,  8, 11,  '2024-10-05 11:00:00', '2024-10-05 11:00:00 -03:00', 'Completed', 12.99,  2.00, 'Credit Card', NULL);
...
INSERT INTO TastyBytes.Inventory (InventoryID, TruckID, IngredientName, QuantityOnHand, UnitOfMeasure, ReorderLevel, ExpirationDate, SupplierNotes, LastRestocked)
VALUES
    (1,  1,  N'Pulled Pork',       25.00, 'lbs',    10.00, '2024-10-15', N'Supplier: Smoke Masters LLC',  '2024-09-28'),
    (2,  1,  N'Brisket',           15.00, 'lbs',    10.00, '2024-10-12', NULL,                            '2024-09-28'),
    (3,  1,  N'BBQ Sauce',         8.50,  'gallons', 5.00, '2025-01-01', N'House recipe',                 '2024-09-15'),
    (4,  2,  N'Corn Tortillas',    200.00,'count',   50.00,'2024-10-20', NULL,                            '2024-10-01'),
    (5,  2,  N'Carne Asada',       18.00, 'lbs',    10.00, '2024-10-10', NULL,                            '2024-09-30'),
    (6,  2,  N'Cilantro',          3.00,  'bunches', 5.00, '2024-10-08', NULL,                            '2024-10-02'),
    (7,  3,  N'Ramen Noodles',     120.00,'portions',30.00,'2024-11-01', N'Imported from Japan',          '2024-09-20'),
    (8,  3,  N'Pork Belly',        12.00, 'lbs',    10.00, '2024-10-14', NULL,                            '2024-10-01'),
    (9,  4,  N'Beef Patties',      80.00, 'count',   20.00,'2024-10-18', NULL,                            '2024-10-05'),
    (10, 4,  N'Burger Buns',       90.00, 'count',   25.00,'2024-10-12', NULL,                            '2024-10-05'),
    (11, 5,  N'Pizza Dough',       30.00, 'balls',  10.00, '2024-10-10', N'Made fresh daily',             '2024-10-06'),
    (12, 5,  N'Mozzarella',        10.00, 'lbs',     5.00, '2024-10-15', N'Buffalo mozzarella',           '2024-10-03'),
    (13, 6,  N'Basmati Rice',      50.00, 'lbs',    15.00, '2025-06-01', NULL,                            '2024-09-01'),
    (14, 6,  N'Chicken Breast',    20.00, 'lbs',    10.00, '2024-10-12', NULL,                            '2024-10-02'),
    (15, 9,  N'Cheese Curds',      5.00,  'lbs',    10.00, '2024-10-09', N'Quebec supplier',              '2024-10-01'),
    (16, 9,  N'Gravy Mix',         2.00,  'lbs',    10.00, '2025-03-01', NULL,                            '2024-08-15');
